...
public class MyAskController { // 또는 MyPageController
    ...
    @GetMapping("/{loginId}/qnas")
    public ResponseEntity<AsksResponse> getMyQnas(@PathVariable String loginId) {
        AsksResponse response = myAskService.getAsksByAuthor(loginId);
