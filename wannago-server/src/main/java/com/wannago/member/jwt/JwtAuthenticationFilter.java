...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if ((method.equals("POST") && (path.equals("/join") || path.equals("/login") || path.equals("/reissue")|| path.equals("/check-email") || path.equals("/posts")|| path.equals("/post"))) ||
                (method.equals("GET") && (path.startsWith("/posts") || path.startsWith("/post/") || path.equals("/qnas") || path.startsWith("/qnas/")))) {
